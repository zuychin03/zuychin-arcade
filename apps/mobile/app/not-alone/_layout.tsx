...
export default function NotAloneLayout() {
  ...
  return <Stack screenOptions={{ headerStyle: { backgroundColor: NOT_ALONE.surface }, headerTintColor: NOT_ALONE.signal, headerTitleStyle: { fontWeight: '800' }, contentStyle: { backgroundColor: NOT_ALONE.bg }, animation: reduceMotion ? 'none' : 'slide_from_right' }}>
