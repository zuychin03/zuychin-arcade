...
export default function Layout() {
  ...
  return <Stack screenOptions={{ headerStyle: { backgroundColor: COLT.surface }, headerTintColor: COLT.ember, headerTitleStyle: { fontWeight: '800' }, contentStyle: { backgroundColor: COLT.bg }, animation: reduceMotion ? 'none' : 'slide_from_right' }}>
