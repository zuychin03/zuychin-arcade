...
export default function Layout() {
  ...
  return <Stack screenOptions={{ headerStyle: { backgroundColor: LIBERTALIA.surface }, headerTintColor: LIBERTALIA.sky, headerTitleStyle: { fontWeight: '800' }, contentStyle: { backgroundColor: LIBERTALIA.bg }, animation: reduceMotion ? 'none' : 'slide_from_right' }}>
