...
export function CartographersReferenceSheet({ visible, onClose }: { visible: boolean; onClose: () => void }) {
  ...
  return <RulesReferenceSheet visible={visible} onClose={onClose} gameTitle="Cartographers Heroes" subtitle="Standalone Heroes · maps C and D · 1–100 players" icon="map-outline"
    ...
    <View style={{ gap: 20 }}>
      <Text accessibilityRole="header" style={{ ...body, color: C.accent, fontFamily: 'Outfit_700Bold', fontSize: 22 }}>Read the terrain</Text>
      ...
      <Text accessibilityRole="header" style={{ ...body, color: C.accent, fontFamily: 'Outfit_700Bold', fontSize: 22 }}>The season calendar</Text>
      ...
      <Text accessibilityRole="header" style={{ ...body, color: C.accent, fontFamily: 'Outfit_700Bold', fontSize: 22 }}>All 19 drawing cards</Text>
      ...
      <Text accessibilityRole="header" style={{ ...body, color: C.accent, fontFamily: 'Outfit_700Bold', fontSize: 22 }}>All 16 scoring objectives</Text>
