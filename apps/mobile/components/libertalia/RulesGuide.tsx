...
const heading = { fontFamily: TYPOGRAPHY.heading.fontFamily, fontSize: 22, lineHeight: 28, color: C.sky } as const;
  ...
  return <View nativeID="libertalia-rules-guide" style={{ gap: 28, minWidth: 0 }}>
    <View style={{ gap: 12 }}>
      ...
      <View style={{ gap: 8, paddingVertical: 12, borderTopWidth: 1, borderBottomWidth: 1, borderColor: C.border }}>
        <Text style={{ ...body, fontFamily: TYPOGRAPHY.heading.fontFamily }}>Illustrative reveal: rank 8 before rank 12</Text>
    ...
    <View nativeID="libertalia-rules-directions" style={{ gap: 20 }}>
      ...
      <View style={{ gap: 8 }}>
        <View style={{ flexDirection: 'row', gap: 8, alignItems: 'center' }}><MaterialCommunityIcons accessible={false} name="white-balance-sunny" size={28} color={C.gold} /><Text style={{ ...body, fontFamily: TYPOGRAPHY.heading.fontFamily, flex: 1 }}>Day: low rank to high</Text></View>
      ...
      <View style={{ gap: 12 }}>
        <View style={{ flexDirection: 'row', gap: 8, alignItems: 'center' }}><MaterialCommunityIcons accessible={false} name="weather-sunset" size={28} color={C.gold} /><Text style={{ ...body, fontFamily: TYPOGRAPHY.heading.fontFamily, flex: 1 }}>Dusk: high rank to low</Text></View>
      ...
      <View style={{ gap: 8 }}>
        <View style={{ flexDirection: 'row', gap: 8, alignItems: 'center' }}><MaterialCommunityIcons accessible={false} name="weather-night" size={28} color={C.violet} /><Text style={{ ...body, fontFamily: TYPOGRAPHY.heading.fontFamily, flex: 1 }}>Night: your ship works again</Text></View>
    ...
    <View style={{ gap: 12, paddingTop: 16, borderTopWidth: 1, borderTopColor: C.border }}>
      ...
      <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 12 }}>{[4, 5, 6].map((days, index) => <View key={days} style={{ flexGrow: 1, flexBasis: 120, gap: 4 }}><MaterialCommunityIcons accessible={false} name="anchor" size={28} color={C.gold} /><Text style={{ ...body, fontFamily: TYPOGRAPHY.heading.fontFamily }}>Voyage {index + 1}</Text><Text style={body}>{days} days</Text></View>)}</View>
